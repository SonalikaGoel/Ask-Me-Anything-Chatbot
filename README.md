...
A Python-based voice assistant that listens to your questions and responds with intelligent answers using Google Gemini AI. Features speech recognition, text-to-speech output, Google Calendar integration, and note-taking capabilities.
